...
export async function POST(req: Request) {
  try {
    ...
    const { vehicleType, baseFare, pricePerKm, pricePerMinute, multiplier } = body;

    if (!vehicleType || baseFare === undefined || pricePerKm === undefined || pricePerMinute === undefined || multiplier === undefined) {
